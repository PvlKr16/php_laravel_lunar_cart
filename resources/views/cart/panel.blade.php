...
<div id="cart-panel" aria-hidden="true">
    ...
    <div id="cart-footer">
        ...
        <div class="fkcart-checkout-info">
            <a href="#" id="fkcart-checkout-button">

                <div class="fkcart-checkout--icon">
                    <svg data-icon="icon-checkout"
                         width="20"
                         height="20"
                         viewBox="0 0 24 24"
                         class="fkcart-icon-checkout"
                         fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="fkcart-checkout--text">Checkout</div>
            </a>
        </div>
